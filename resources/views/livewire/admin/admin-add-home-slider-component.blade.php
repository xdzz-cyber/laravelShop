            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        @endif
                        <form method="post" enctype="multipart/form-data" class="form-horizontal" wire:submit.prevent="addSlide">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="file" placeholder="image" class="form-control form-control-sm" wire:model="image">
                                    @if($image)
                                        <img src="{{$image->temporaryUrl()}}" class="img-fluid w-25" alt="user chosen image">
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="form-group text-center">
                                <div class="col-md-12">
                                    <input type="submit" class="btn btn-success" value="Add new slide">
                                </div>
                            </div>
