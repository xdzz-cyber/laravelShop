                ...
                <div class="wrap-product-detail">
                    ...
                    <div class="detail-info">
                        <div class="product-rating">
                            ...
                            @foreach($product->orderItems->where("reviewStatus",1) as $orderItem)
                                @php
                            ...
                            @for($i = 1; $i < 5; $i++)
                                @if($i < $avgRating)
                                    <i class="fa fa-star" aria-hidden="true"></i>
                                @else
                                    <i class="fa fa-star colorGray" aria-hidden="true"></i>
                                @endif
                            @endfor
                            <a href="#" class="count-review">({{$product->orderItems->where("reviewStatus",1)->count()}} review)</a>
                        </div>
                        ...
                        @if($product->sale_price > 0 && $saleTimeRecord->status == 1 && $saleTimeRecord->sale_date > \Carbon\Carbon::now())
                        ...
                        <div class="tab-contents">
                            ...
                            <div class="tab-content-item " id="review">
                                ...
                                <div class="wrap-review-form">
                                    ...
                                    <div id="comments">
                                        <h2 class="woocommerce-Reviews-title">{{$product->orderItems->where("reviewStatus",1)->count()}} review for <span>{{$product->name}}</span>
                                        </h2>
